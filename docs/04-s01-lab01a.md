...
**Title: ** Volunteering during the COVID-19 pandemic does not boost well-being: variability in the well-being benefits of prosocial behaviour 
...
**Title: ** Exploring  Fatigue in Care Home Workers during COVID-19 
...
**Name: ** Amy Megan Paterson 

**Supervisor: ** Heather Cleland Woods 

**Title: ** The role of perceived social isolation and online social support on sleep quality of students during the COVID-19 pandemic 
...
**Name: ** Rebeka Pazmanyova 

**Supervisor: ** Esther Papies 

**Title: ** "Just like it's still there, but it's ... doesn't have as big of an effect on me": Students' Experiences of Learning and Applying Brief Mindfulness to COVID-19 Related Anxiety 

**Abstract: ** While brief mindfulness has been shown effective in various domains of health and wellbeing, these findings are mainly based on quantitative research. In the present qualitative study, we explored how university students without previous meditating experience learn and apply brief mindfulness to the anxiety-provoking aspects of COVID-19. To describe and make sense of participants' experience of mindfulness, we used an exploratory case study design. We recruited 16 undergraduate students from the University of Glasgow. In four focus groups, participants first identified an anxiety-provoking aspect of COVID-19. Secondly, they discussed their experience of writing and thinking about this aspect. Next, participants listened to a five-minute recording of mindfulness. Finally, they applied the instructions to their aspect for two minutes and then discussed their experiences. The data was analysed using thematic analysis. Our results suggest that participants perceived the brief mindfulness-based instructions as clear and easy to learn. Importantly, visual metaphor played a key role in understanding the essence of decentering. As a result of applying the instructions, participants were able to experience the anxiety-provoking aspects in a transient way. Furthermore, they reported feeling more detached from their anxiety-provoking aspects, and less overwhelmed by them. In the future, participants would use brief mindfulness in specific short-term situations across domains. Brief decentering-based instructions may be a potential tool that is accessible and effective to help university undergraduate students with the mental health implications of the COVID-19 pandemic. 

---

**Name: ** Annelie Gisele Perruchoud 

**Supervisor: ** Frank E. Pollick 

**Title: ** Individual Differences in the Uncanny Valley Effect: Broader Autism Phenotype Effects 

**Abstract: ** The uncanny valley effect (UVE) refers to the non-linear relationship between the human-likeness of an artificial agent and the perceiver's affinity towards that agent, with highly (yet not perfectly) realistic agents tending to elicit strong negative affect. This research provides a comprehensive rationale for a relationship between autism and the individual differences in the UVE with a focus on conceptualising autism as being a continuous dimension. It then extends prior research by presenting an empirical study that directly measures this relationship in a non- clinical, adult sample. A within-subjects online experiment involved 73 participants who reported their likeability and eeriness responses to faces ranging on the human-likeness dimension (HLD) and completed the broader autism phenotype questionnaire (BAP-Q). A mixed-effects polynomial approach was adopted to continuously capture the effect of the BAPQ on the UVE. Although all participants displayed responses characteristic of the UVE, analyses revealed distinct BAP-Q subscale effects: an interacting effect of the aloof subscale and HLD on likeability for the first polynomial term (p < 0.005) and main negative effects of BAP-Q total, pragmatic language and rigid scores on eeriness (p < 0.05). Limited by low internal consistency of the BAP-Q subscales, the results provide tentative evidence for the distinct mechanisms of action of BAP sub-domains on the positive and negative emotions associated with the UVE. Implications, along with the limitations are discussed, in light of the promising individual differences approach to the UVE for our understanding human-robot interaction in the context of autism therapy and beyond. 

---

**Name: ** Claire Elektra Philippides 

**Supervisor: ** Lorna I. Morrow 

**Title: ** Effectiveness of an online intervention to improve resilience in undergraduate students 

**Abstract: ** **Introduction: **The rates of mental health issues that undergraduate students experience and the demand placed on university counseling services have been steadily increasing. Thus, there is a need to create interventions that help students manage their mental health needs and increase resilience without putting more pressure on counseling services. The aim of the present study was to test the efficacy of a short, online resilience intervention on undergraduate students in a randomized control trial.<br>
**Method: **Participants were 15 undergraduate students at various Scottish universities. The online intervention in this study was created using research-based positive psychology and mindfulness activities. The participants completed the Connor-Davidson Risk and Resilience Scale (CD-RISC 25; Connor & Davidson, 2003) immediately before and after completing their respective control or intervention activities. It was hypothesized that there would be a significantly greater increase in resilience levels of students who complete the resilience intervention when compared to the control group<br>
**Results: **Results of an ANCOVA showed that the intervention did not significantly increase participant post-test resilience scores. <br>
**Discussion: **The implications of the results are discussed. Possible explanations of these results include the Covid-19 pandemic, the impact of culture on resilience levels, and potential disinterest regarding the intervention. While the results in this study were not significant, they provide a base for further research into effective online resilience interventions for undergraduates. 

---

**Name: ** Nikola Pokorna 

**Supervisor: ** Judith L. Stevenson 

**Title: ** Prevalence and Exacerbating Factors of Body-Focused Repetitive Behaviours in the LGBTQ+ Community 

**Abstract: ** Even though LGBTQ+ individuals are at high risk of experiencing mental health issues, no research has investigated the associations between LGBTQ+ identity and body-focused repetitive behaviours (BFRBs). This study aimed to explore this possible link by looking at the prevalence of BFRB symptomology in the LGBTQ+ community and exacerbating factors. This study employed a between-subjects design to compare differences between participants who self-reported BFRB symptomology and those who did not. LGBTQ+ participants were recruited via convenience sampling to complete an online survey. Prevalence rates of BFRB symptomology were found to be higher in the LGBTQ+ sample in comparison to literature on the heteronormative/cisgender population. Out of the total sample (N = 753), 234 (31.1%) participants self-reported BFRB symptomology. Of those, 95 (12.6%) reported hair pulling, and 177 (23.5%) skin picking. Through multiple t-tests, participants with BFRB symptomology reported greater levels of negative emotional states, LGBTQ+ stigma and discrimination, family rejection, and intersectional stigma for BFRBs and mental health issues. Transgender individuals with BFRB symptomology also reported higher levels of dysmorphic appearance concern. No significant differences were found on LGBTQ+ outness. A further exploratory analysis revealed some differences between BRFB conditions. Results suggest that LGBTQ+ individuals face unique factors that may exacerbate BFRB symptomology. These findings could enhance treatments of BFRBs in the LGBTQ+ community. It is anticipated that the current study will stimulate further investigation of this important area. 
...
**Title: ** The Role of Perceptual Choice Confidence in the Speed-Accuracy Tradeoff 

**Abstract: ** The speed-accuracy tradeoff characterises a fundamental property of decision making where more accurate decisions typically require a longer time, whereas fast decisions tend to be error-prone. Furthermore, each decision is associated with a subjectively perceived degree of uncertainty. Choice confidence constitutes a metacognitive ability to reflect on a committed decision and estimate its accuracy. Nonetheless, the role of decision confidence within the speed-accuracy tradeoff is largely unknown. The present study aimed to investigate this question by analysing a previously unexplored secondary dataset whereby subjects performed perceptual decisions about a direction of moving dot kinematograms and subsequently rated their confidence about the choice. Firstly, in this work, the speed-accuracy tradeoff was successfully replicated. Secondly, non-parametric tests revealed a greater distributional spread of confidence ratings when subjects were instructed to prioritise decision speed, compared to accuracy-emphasis instructions. The results were discussed in relation to the neural mechanism of choice confidence. Moreover, enhanced distributional differences of confidence ratings were found across lower deciles (accuracy-emphasis instructions > speed-emphasis instructions), although statistically non-significant. Thirdly, intertrial sequential effects of confidence ratings onto response times showed that higher choice confidence (trial n) translated to slower decision speed (trial n+1). These findings were contextualised within neuroscientific research and computational approaches to decision-making processes. 

---

## Surnames beginning with R {-}

**Name: ** Adeela Tul Marwa Rana 

**Supervisor: ** Linda M. Moxey 

**Title: ** The Racial and Ethnic differences between South Asians and Caucasians in Seeking Mental Health Treatment in Scotland with respect to Stigma during COVID-19 
...
**Name: ** Madeleine Rawlinson 

**Supervisor: ** Niamh Stack 

**Title: ** Exploring the student well-being of adolescent girls with Prader-Willi syndrome: a qualitative study 
...
**Title: ** Depression is Related to Religiosity but not the Perception of Emotion in Voices 
...
**Name: ** Leonie Jack Hughes Richardson 

**Supervisor: ** Maria Gardani 

**Title: ** Students' Personal Social Networks and Mental Health During the First Year at University: An Egocentric Network Analysis 
...
**Title: ** Exploring the experience of people transitioning toward reducing meat and dairy consumption 
...
**Title: ** Pivot to Online Teaching and Widening Participation in UK Higher Education 

**Abstract: ** Sudden pivot to online teaching due to the COVID-19 pandemic forced higher education teaching staff to adapt quickly. In the UK, widening participation is a central concept in higher education. Previous research suggested that online teaching can support widening participation. We surveyed UK higher education teaching staff (N = 55) to explore the impact of the pivot to online teaching on widening participation issues of accessibility and equity. Online qualitative surveys were conducted to explore what challenges and opportunities for widening participation were experienced. Employing thematic analysis, five major themes were identified: digital poverty, unsuitable environments, accessibility, student engagement, and workload. Future implications for improving widening participation and online teaching are discussed. We conclude that online teaching can support accessibility and equity of higher education, however, challenges and inequalities to widening participation are persistent in an online environment. 
...
**Title: ** Spray it and Say it: A Study on Youth-Led Programmes and Mental Well-Being 
...
**Name: ** * Sarveen Sadique 

**Supervisor: ** Frank E. Pollick 

**Title: ** Does the High, Inflexible Precision of Predictions Errors truly explain the lived experiences of autistic individuals? 
...
**Title: ** Intolerance of uncertainty (IU): The Relationship Between IU and traits of ASD 
...
**Title: ** COVID-19 Stress, FOMO and Compliance to COVID-19 Prevention Guidelines in First Year University Students 
...
**Name: ** Sophia Schmeing 

**Supervisor: ** Margaret S. Martin 

**Title: ** Exploring Cultural Differences in Attitudes Towards Restorative Justice Initiatives for Sex Offenders 
...
**Name: ** Leonie Schorrlepp 

**Supervisor: ** Emily Nordmann 

**Title: ** "You're still alone in a room with no one near you" - Undergraduate Students' Experience of Sense of Belonging During the COVID-19 Pivot to Online Teaching 
...
**Name: ** Bethany Shelton 

**Supervisor: ** Niamh Stack 

**Title: ** Making Sense of Family: A Story Completion Study of Birth Children of Foster Carers 
...
**Name: ** Mathilde Sijtsma 

**Supervisor: ** Frank E. Pollick 

**Title: ** Gesture Perception in Major Depression: An Investigation using fMRI Data 
...
**Name: ** Martina Simovicova 

**Supervisor: ** Dale Barr 

**Title: ** Exploring the Relationship between Life Satisfaction, Belief in Conspiracy Theories and Trust in Science and Scientists 
...
**Name: ** Rhianna Claire Skedge 

**Supervisor: ** Ashley Robertson 

**Title: ** The Relationship of Autistic Traits, Intolerance of Uncertainty (IoU) and Anxiety in the General Population 
...
**Title: ** An Explorative Qualitative Study of Virtual Teamwork within a Senior Leadership Team During the COVID-19 Pandemic 
...
**Title: ** Online Interventions to Improve Students' Sleep: A Systematic Review 
...
**Title: ** Using Virtual Reality to Recreate the Synaesthetic Experience 
...
**Title: ** An Investigation Into Mental Health in Students During the Covid-19 Pandemic, With a Focus on Skin-Picking and Hairpulling 
...
**Name: ** Maria Ten Sierra 

**Supervisor: ** Eugene J. Dawydiak 

**Title: ** Stigma Towards Surrogate Mothers is Predicted by Pathogen, Sexual and Moral Disgust 
...
**Name: ** Oona Elena Terhia 

**Supervisor: ** Eugene J. Dawydiak 

**Title: ** Pathogen Disgust Sensitivity as a predictor of Mental Disorder Stigma: Testing the moderating effect of Pathogen Cue Priming 
...
**Title: ** Examining Facial Expressions as Social Tools 
...
**Name: ** Ailish Margaret Thomson 

**Supervisor: ** Eugene J. Dawydiak 

**Title: ** Pathogen Disgust Predicts Stigmatisation of Individuals with Neurodevelopmental Disorders 
...
**Name: ** Ioana Paula Tonceanu 

**Supervisor: ** Lawrence Barsalou 

**Title: ** Assessing Emotional Experience during the Covid-19 Pandemic: The Situated Perspective on Emotion Differentiation 
...
**Name: ** Daniel Torbett-Schofield 

**Supervisor: ** Lars Muckli 

**Title: ** Differentiated Neural Response to a Cross-Modal Imagery Paradigm in Aphantasic and Normally Sighted Participants: A Granger Causality Mapping Study 
...
**Name: ** Louis Bahr Trebucq 

**Supervisor: ** Edwin Robertson 

**Title: ** A Content Analysis of Gender Roles in the Expression of Negative Emotions in Children Cartoon Series 
...
**Title: ** The effect of switching to online teaching and assessment during COVID-19 on test anxiety and preparedness in undergraduate students 

**Abstract: ** The impacts on social interaction due to COVID-19 have been wide and varied, most clearly illustrated in the changes to how university teaching and assessment has taken place since March 2020. The effects of these changes on test anxiety and preparation for online exams in UK undergraduates has yet to be considered in-depth, therefore we conducted a qualitative study to determine the individual experiences of this in a cohort of undergraduate/recent graduate students. Interpretive Phenomenological Analysis was performed on the collected data and results showed variable experiences of five common factors of the sudden move to online teaching and exams which emerged. These factors were; environment, exam format, a timeline of anxiety, staff/student communication and reflection. The individual experiences of these elements and further possible impacts on future implementation of online exams and research in this area are discussed in-depth below. 

---

## Surnames beginning with V {-}

**Name: ** Nelli Aurora Valkamo 

**Supervisor: ** Lawrence Barsalou 

**Title: ** Mindfulness and self-compassion account for a large amount of variance in the relationship between autism and camouflaging 
...
**Name: ** Nikolaos Vitsakis 

**Supervisor: ** Lisa M. DeBruine 

**Title: ** Data Sharing and Hypothesis generation: A pilot study 
...
**Title: ** Does Facial Age Differentially Affect the Sex Categorisation of Male and Female Faces? A Replication Study 

**Abstract: ** We are able to tell the sex of an unfamiliar face within milliseconds, which has important downstream consequences for social interaction. Whilst research suggests that a variety of cues contribute to the sex categorisation of faces, little is known about how orthogonal facial dimensions, such as facial age, modulate this process. Here, I replicated a sex categorisation experiment by Kloth et al. (2015) to investigate how older facial age influenced the efficiency and accuracy with which the sex of unfamiliar faces was categorised. 244 participants categorised the sex of face stimuli ranging in age from young to middle-aged and old. Accuracy and response latencies were analysed by replicating Kloth et al. (2015)'s ANOVA analysis, and then computing mixed-effects models and hierarchical shift functions. My results were consistent with an asymmetric influence of facial age on sex categorisation, where older male faces are categorised faster and more accurately than young faces, whilst inversely female faces are harder to categorise with increased age. However, these outcomes need to be replicated in controlled environments with robust statistical methods for further insight into the intersection of perceptual processing and contextual factors in face categorisation. 

---

## Surnames beginning with W {-}

**Name: ** Erin Alicia Wareing 

**Supervisor: ** Margaret S. Martin 

**Title: ** Stigma Towards Offenders with Mental Illness: An Investigation of Empathy and Mental Illness Symptomatology 
...
**Name: ** Genevieve Rose Warrender 

**Supervisor: ** Margaret S. Martin 

**Title: ** Dark Personality Traits and Sociopolitical Ideologies: Investigating the Dual Process Motivational Model of Prejudice 
...
**Title: ** Exploring the Extent Meta-Dehumanisation Influences the Relationship Between Subjective Social Status and Psychological Well-being 
...
**Name: ** Karolina Wlodyka 

**Supervisor: ** Phil McAleer 

**Title: ** The Relationship Between the Listeners' Personality and Their Perception of the Voice Trustworthiness 
...
**Title: ** A Meta-Analysis to Quantify Lateralised Spatial Attention Bias (Pseudoneglect) in Attention Deficit Hyperactivity Disorder 
...
**Name: ** Lawrence William John Wright 

**Supervisor: ** Ian Bushnell 

**Title: ** Exploration of the Relationship between Students' Social Ability, Academic Motivation, and Cognitive Load in Online Learning Environments 

**Abstract: ** The current research employed a sequential explanatory mixed methods design to add to the limited literature surrounding social ability in online learning environments. This study studied the relationship between social ability, academic motivation, and cognitive load. Questionnaires were administered to first-year psychology students (N = 40). Eight follow-up interviews were conducted, to glean student perceptions of the role of social ability on academic motivation and cognitive load. Regression analyses indicated that student's intrinsic and extrinsic motivation could be predicted by social navigation and social connectedness. Later interviews suggested that students felt isolation from peers and experienced the sense that lecturers were not heavily involved in their learning experience. The importance of social navigation on motivation was seen through social media groups as a way to expand knowledge and improve their own work. Social connectedness was important as students valued the feeling that other students were in the same situation as them, with these feelings acting as a motivator to persist with university. Implications for the findings for educational practice and future research and limitations are discussed. 
...
**Title: ** Exploring the Relationship Between Disgust Sensitivity and Internalised Stigma in Trichotillomania and Dermatillomania 

**Abstract: ** The behavioural immune system aids humans in avoiding pathogens in the environment. However, this system may be overgeneralised, leading to the avoidance and stigmatisation of individuals with non-infectious conditions, such as body-focussed repetitive behaviours (BFRBs). We investigated whether this overgeneralisation extends to internalised stigma. It was anticipated that pathogen disgust, not sexual or moral disgust, would predict self-stigma in those with BFRBs. A correlational design was employed to investigate the relationship between disgust sensitivity and self-stigma in individuals with trichotillomania symptomatology and dermatillomania symptomatology. A final sample of 527 participants was recruited through social media and BFRB-oriented forums. Participants completed an appropriate screening questionnaire for the BFRB condition they most identified with. Self-stigma and disgust sensitivity were then measured using an adapted version of the Internalised Stigma of Mental Illness-Brief scale (ISMI-B) and the Three Domains of Disgust Scale (TDDS), respectively. Through multiple regression analyses, we found that sexual disgust, and not moral or pathogen disgust, predicted self-stigma in our total sample and our trichotillomania sub-sample (p < .001). No domain of disgust significantly predicted self-stigma for those with dermatillomania symptomatology, with the full model also found to be non-significant (p = .275). These results indicate that the behavioural immune system may not be involved in the self-stigmatisation of individuals with trichotillomania and dermatillomania, at least in the context of pathogen disgust. Alternative explanations and implications for future research and practice are discussed. 
